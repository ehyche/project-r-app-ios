...
- (void)useCredential:(NSURLCredential *)credential forAuthenticationChallenge:(NSURLAuthenticationChallenge *)challenge {
    NSLog(@"PJURLProtocolRunLoop[%p]: useCredential:%@ forAuthenticationChallenge:%@", self, credential, challenge);
...
- (void)continueWithoutCredentialForAuthenticationChallenge:(NSURLAuthenticationChallenge *)challenge {
    NSLog(@"PJURLProtocolRunLoop[%p]: continueWithoutCredentialForAuthenticationChallenge:%@", self, challenge);
    [self finishDueToNoPassword];
}

- (void)cancelAuthenticationChallenge:(NSURLAuthenticationChallenge *)challenge {
    NSLog(@"PJURLProtocolRunLoop[%p]: cancelAuthenticationChallenge:%@", self, challenge);
    [self finishDueToNoPassword];
}
